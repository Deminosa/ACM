package de.deminosa.lezora.acm.api;
...
public class AdvancementMessage extends DisplayMessage	{
	...
	public AdvancementMessage(FrameType type, String title, JavaPlugin pl)	{
		this(type, title, Material.OAK_SIGN, pl);
	}
	
	public AdvancementMessage(FrameType type, String title, Material icon, JavaPlugin pl)	{
		this(new NamespacedKey(pl, UUID.randomUUID().toString()), type, title, icon, pl);
	}
	
	public AdvancementMessage(String id, FrameType type, String title, Material icon, JavaPlugin pl)	{
		this(new NamespacedKey(pl, id), type, title, icon, pl);
	}
	
	public AdvancementMessage(NamespacedKey id, FrameType type, String title, Material icon, JavaPlugin pl) {
		this.id = id;
	...
	public String getJson()	{
        ...
        icon.addProperty("item", this.icon.name());
        ...
        display.addProperty("frame", frame.name().toLowerCase());
